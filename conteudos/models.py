...
class TEMA(models.Model):
    ...
    img_tema_home = models.CharField(max_length=25, default='', verbose_name='Nome da Img Tema (home)')
    img_tema_pag = models.CharField(max_length=25, default='', verbose_name='Nome da Img Tema (pág)')
